...
final class SchedulerDoctorFindingTest extends TestCase
{
    ...
    {
        $f = new SchedulerDoctorFinding(SchedulerDoctorCheck::C1, SchedulerDoctorStatus::Pass, 'All good.');
    ...
    {
        $f = new SchedulerDoctorFinding(SchedulerDoctorCheck::C1, SchedulerDoctorStatus::Fail, 'Something broken.');
    ...
    {
        $f = new SchedulerDoctorFinding(SchedulerDoctorCheck::C3, SchedulerDoctorStatus::Skip, 'Not applicable.');
        self::assertFalse($f->isFailure());
        self::assertFalse($f->isPassing());
    }
    ...
    {
        $f = new SchedulerDoctorFinding(SchedulerDoctorCheck::C5, SchedulerDoctorStatus::Fail, 'Missing table.', 'detail text', 'run migrations');
    ...
    {
        $f = new SchedulerDoctorFinding(SchedulerDoctorCheck::C1, SchedulerDoctorStatus::Pass, 'OK');
